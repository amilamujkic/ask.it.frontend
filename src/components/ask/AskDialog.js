...
class AskDialog extends Component {
  ...
  handleOpen = () => {
    ...
    const { userHandle, askId } = this.props;
    const newPath = `/users/${userHandle}/ask/${askId}`;
    ...
    this.props.getAsk(this.props.askId);
  };
  handleClose = () => {
